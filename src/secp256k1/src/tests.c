...
static int precomputed_nonce_function(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const char *algo, unsigned int counter, const void *data) {
    (void)msg32;
    (void)key32;
    (void)algo;
...
static int nonce_function_test_fail(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const char *algo, unsigned int counter, const void *data) {
   /* Dummy nonce generator that has a fatal error on the first counter value. */
   if (counter == 0) {
       return 0;
   }
   return nonce_function_rfc6979(nonce32, msg32, key32, algo, counter - 1, data);
}

static int nonce_function_test_retry(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const char *algo, unsigned int counter, const void *data) {
   ...
   return nonce_function_rfc6979(nonce32, msg32, key32, algo, counter - 5, data);
}
