...
void static BitcoinMiner(CWallet *pwallet)
{
	...
	CBlock *pblock = pblocktemplate.get();
        ...
        LogPrintf("Running Vermo Miner with %llu transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("Vermo Miner terminated\n");
        throw;
    }
}
